...
if ( ! class_exists( 'Ced_Ebay_Orders_View' ) ) {
	class Ced_Ebay_Orders_View {


		public function ced_ebay_renderOrderViewHTML() {
	  ...
	  <div class="premium-card col-11 col-sm-9 col-md-7 col-lg-5 d-flex flex-column justify-content-center align-items-around">
		<div class="d-flex flex-nowrap justify-content-around align-items-center">
		  <div class="d-flex flex-column justify-content-start align-items-start">
			<h3 class="upgrade-heading">Sync your eBay Orders</h3>
			<p class="upgrade-text">
			  Upgrade to full version to automatically import your eBay Orders in your WooCommerce store.
			</p>
			<div class="upgrade-btn-container">
			<button class="upgrade-btn" ><a href="https://woocommerce.com/products/ebay-integration-for-woocommerce/?quid=eb215c39718f271235a31fd70ac12fbb" style="color:white;" target="_blank">Upgrade to Full Version</a></button>
			</div>
		  </div>
		</div>
	  </div>
...
$obj = new Ced_Ebay_Orders_View();
$obj->ced_ebay_renderOrderViewHTML();
?>
